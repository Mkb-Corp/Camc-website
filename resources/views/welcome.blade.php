...
<head>
    ...
    <title>Cedrick Axel Management & Consulting SARL</title>
    ...
    <link rel="stylesheet" href="{{ asset('assets/fonts/use.fontawesome.com/releases/v5.9.0/css/all.css') }}">
...
<body>
    <div class="page-wrapper">
        ...
        <section class="hero-section overlay">
            <div class="container">
                <div class="hero-inner">
                    <span class="sub-title wow fadeInUp" data-wow-duration="1s">We Provide the best.</span>
                    <h1><span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.3s">Consulting &</span><br>
                     <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.5s">Management</span><br>
                      <span class="wow fadeInUp" data-wow-duration="1s" data-wow-delay="0.8s">Solutions</span></h1>
                    <a href="#" class="theme-btn wow fadeInUp" data-wow-duration="1s" data-wow-delay="1s">Contact Us <i class="fas fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
        <!--====================================================================
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            <div class="section-title mb-25 wow fadeInUp" data-wow-duration="2s">
                                <h2>About<br> <span>Us.</span></h2>
                            </div>
                            <p class="wow fadeInUp" data-wow-duration="2s">CAMC SARL is a managent and consulting company establihsd and registered in the democratic republic of the congo, empowered and equiped with talented team members and experienced professionals. Our expertise is in providing ideal conditions for establishing in or relocating a business to the DRC, as well as subsequent support and maintenance of the company's ongoing operations.</p>

                            <i class="wow fadeInUp" data-wow-duration="2s">We have leading experts that specialise in registering companies, opening bank accounts, tax and accounting, HR, and Financial services, preparing all necessary paperwork, and providing partner nominee services for your convenience.
                                Our professional team provides clients with fast and efficient communication. Our experts have a very good understanding and knowledge of the business enviroment and affairs in the DRC as well as the african continent, and are able to provide outstanding support to your convience.</i>
        ...
        =====================================================================-->
        <section id="vision" class="vission-mission py-150 rpy-100">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <div class="vission-content-wrap">
                            <div id="tab_2" class="vission-tab-content active">
                                <div class="section-title">
                                    <h2>At CAMC, we see things differently, your business is impacted to boost your future, based on the following <span>core values.</span></h2>
                                </div>
                                <ul>
                                    <li>Precision</li>
                                    <li>Flexibility</li>
        ...
        =====================================================================-->
        <section id="services" class="services-section bg-snow pt-140 rpt-90 pb-110 rpb-60">
            <div class="container">
